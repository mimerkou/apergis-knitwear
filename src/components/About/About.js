        ...
        <div className="company-info">
          <div className="company-description padding-right animate-left">
            ...
            <p data-aos="zoom-in" data-aos-duration="1000" data-aos-once="true">
              ...
              BSB, Attrativo και Helmy, καθώς και με εταιρείες του εξωτερικού
              όπως η Many Ways SA. Προσφέρουμε χονδρική και λιανική πώληση των
              πλεκτών μας. Στον χώρο της εταιρείας μας λειτουργεί και show room
              για την επίδειξη των ενδυμάτων μας.
            </p>
            <div
              data-aos="zoom-in-up"
              data-aos-duration="1000"
